...
def test_from_date_parsed_relative() -> None:
    from nextlabs_sdk._cli import _time_parser

    when(_time_parser).now_epoch_ms().thenReturn(1_000_000)
...
def test_inline_from_date_defaults_to_date_to_now() -> None:
    from nextlabs_sdk._cli import _activity_log_query_builder as builder_mod

    when(builder_mod).now_epoch_ms().thenReturn(4_242_000)
...
def test_inline_explicit_to_date_preserved() -> None:
    from nextlabs_sdk._cli import _activity_log_query_builder as builder_mod
...
def test_inline_without_from_date_defaults_both() -> None:
    from nextlabs_sdk._cli import _activity_log_query_builder as builder_mod
...
def test_inline_without_dates_defaults_last_24h() -> None:
    from nextlabs_sdk._cli import _activity_log_query_builder as builder_mod

    now_ms = 1_737_014_400_000
    when(builder_mod).now_epoch_ms().thenReturn(now_ms)
...
def test_inline_only_to_date_defaults_from_date_24h_earlier() -> None:
    from nextlabs_sdk._cli import _activity_log_query_builder as builder_mod
